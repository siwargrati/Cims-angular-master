...
var RhGuard = /** @class */ (function () {
    function RhGuard(router, tokenStorage) {
        this.router = router;
        this.tokenStorage = tokenStorage;
    }
    RhGuard.prototype.canActivate = function (next, state) {
...
exports.RhGuard = RhGuard;
//# sourceMappingURL=rh.guard.js.map