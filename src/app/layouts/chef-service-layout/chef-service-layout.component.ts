...
import { NavbarComponent } from "../../componentsDirecteur/navbar/navbar.component";
...
export class ChefServiceLayoutComponent implements OnInit {
  ...
  ngOnInit() {
    this.userService.getchefServiceBoard().subscribe(
      data => {
        this.content = data;
      },
      err => {
