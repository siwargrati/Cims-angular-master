...
@Component({
  selector: "app-navbarDirecteur",
  templateUrl: "./navbar.component.html",
  styleUrls: ["./navbar.component.css"]
})
export class NavbarComponent implements OnInit {
  notification: any = [{ id_notification: "", message: "" }];
  message: String;
  ...
  notif() {
    this.notificationService.makeNotificationsTrue().subscribe(res => {
      console.log(res);
    });
    this.numberofnonevu = 0;
  }
  aaaaa() {
    this.notificationService.getNotifById().subscribe(res => {
      console.log(res);
